...
export const NON_API_TRANSLATE_PROVIDERS = ['google', 'microsoft', 'builtIn'] as const
export const NON_API_TRANSLATE_PROVIDERS_MAP: Record<typeof NON_API_TRANSLATE_PROVIDERS[number], string> = {
  google: 'Google Translate',
  microsoft: 'Microsoft Translator',
  builtIn: 'Built-in Translator',
}
export const PURE_TRANSLATE_PROVIDERS = ['google', 'microsoft', 'builtIn', 'deeplx'] as const
...
export const TRANSLATE_PROVIDER_NAMES = ['google', 'microsoft', 'builtIn', 'deeplx', 'openai', 'deepseek', 'gemini', 'anthropic', 'grok', 'openaiCompatible', 'siliconflow', 'tensdaq', 'ai302', 'amazonBedrock', 'groq', 'deepinfra', 'mistral', 'togetherai', 'cohere', 'fireworks', 'cerebras', 'replicate', 'perplexity', 'vercel', 'openrouter'] as const satisfies Readonly<
...
// all provider names
export const ALL_PROVIDER_NAMES = ['google', 'microsoft', 'builtIn', 'deeplx', 'siliconflow', 'tensdaq', 'ai302', 'openaiCompatible', 'openai', 'deepseek', 'gemini', 'anthropic', 'grok', 'amazonBedrock', 'groq', 'deepinfra', 'mistral', 'togetherai', 'cohere', 'fireworks', 'cerebras', 'replicate', 'perplexity', 'vercel', 'openrouter'] as const satisfies Readonly<
